...
**This document defines how the Pillar build engine proves it works. The agent MUST be able to build a complete demo site from a scripted scenario without any human input, then validate it against all spec documents. This is how you test without doing everything yourself.**
...
The agent does ALL of this itself. You say "run the self-test" and it builds a demo site, validates it, and reports results.
...
Using the simulated interview data above, build the complete site following:
...
**Verification:** Site builds without errors and is accessible at the test URL.
