...
const VERTICALS: Record<string, VerticalConfig> = {
  lodges: {
    ...
    benefits: [
      ...
      { icon: icon(Share2), title: "Automatic social media presence", body: "Pillar posts meeting reminders, event announcements, and lodge news to Facebook and Instagram on autopilot." },
      { icon: icon(Bot), title: "AI updates — no committee required", body: "When things change, just chat with Pillar. It updates your site instantly. No FTP, no passwords, no IT guy." },
    ],
  ...
  rotary: {
    ...
    heroSub: "Focus on your community projects, not your website. Pillar keeps your club's digital presence professional, current, and fully automatic.",
    ...
    benefits: [
      ...
      { icon: icon(Share2), title: "Social media on autopilot", body: "Pillar drafts and posts your service updates, event promotions, and club news to your social accounts automatically." },
  ...
  vfw: {
    ...
    heroSub: "Honor your members' service with a professional online presence. Pillar builds and maintains your post's website so you can focus on serving veterans.",
    ...
    benefits: [
      ...
      { icon: icon(Share2), title: "Recruiting on social media", body: "Pillar posts veteran-focused content, event announcements, and post news to Facebook automatically. New members find you." },
      { icon: icon(Users), title: "Continuity across leadership", body: "When the Commander changes, nothing breaks. Pillar preserves your digital presence through every leadership transition." },
    ],
  ...
  hoa: {
    ...
    benefits: [
      ...
      { icon: icon(Bot), title: "AI-powered document updates", body: "Changed a policy? Just tell Pillar. Your website, announcement, and relevant documents update simultaneously." },
    ],
  ...
  pta: {
    ...
    heroSub: "Stop chasing RSVPs and resending reminder emails. Pillar keeps your school community connected automatically.",
    ...
    benefits: [
      ...
      { icon: icon(Share2), title: "Automated school social media", body: "Pillar drafts and posts your event reminders, fundraiser updates, and school news to your social pages on a schedule you control." },
      { icon: icon(Zap), title: "Continuity every school year", body: "When the board changes in June, Pillar keeps running. New leadership inherits a fully operational digital presence on day one." },
    ],
  ...
  nonprofits: {
    ...
    benefits: [
      ...
      { icon: icon(Bot), title: "AI content that sounds like you", body: "Pillar learns your voice, tone, and mission. Every post, page update, and announcement sounds authentic — not AI-generated." },
    ],
