...
- Name: 01-platform-health.spec.ts >> Platform Health >> Asset files return correct content types not HTML
- Location: artifacts/e2e/01-platform-health.spec.ts:45:7
...
Call log:
  - → GET http://localhost:8080/sites/norwin-rotary-uic5
